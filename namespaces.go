...
var (
	...
	NamespaceMetrics = []metric{
                ...
                {collGauge, "memory-size", "memory size"},
                {collGauge, "high-water-memory-pct", "high water memory pct"},
                {collGauge, "stop-writes-pct", "stop writes pct"},
                {collGauge, "high-water-disk-pct", "high water disk pct"},
